...
bisos.py2-all: is a top level module that requires core  BISOS (ByStar Internet Services OS) modules.
...
\item unisos.ucf
\item unisos.icm
\item unisos.icmExamples
\item bisos.common
\item bisos.bx-bases
\item bisos.bootstrap
\item bisos.examples
\item blee.icmPlayer
\end{itemize}

bisos.py2-all: is a top level module that requires core  BISOS and all BISOS Pkgs (Feature Areas).
