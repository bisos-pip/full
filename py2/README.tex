...
bisos.core: is a top level module that requires core  BISOS (ByStar Internet Services OS) modules.
...
bisos.all: is a top level module that requires core  BISOS and all BISOS Pkgs (Feature Areas).
